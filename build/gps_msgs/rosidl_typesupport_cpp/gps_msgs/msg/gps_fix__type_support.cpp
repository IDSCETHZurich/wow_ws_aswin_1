...
static const _GPSFix_type_support_symbol_names_t _GPSFix_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gps_msgs, msg, GPSFix)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gps_msgs, msg, GPSFix)),
  }
};
...
{
  return &::gps_msgs::msg::rosidl_typesupport_cpp::GPSFix_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gps_msgs, msg, GPSFix)() {
  return get_message_type_support_handle<gps_msgs::msg::GPSFix>();
}
