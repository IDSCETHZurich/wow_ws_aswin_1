...
static const _GPSStatus_type_support_symbol_names_t _GPSStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gps_msgs, msg, GPSStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gps_msgs, msg, GPSStatus)),
  }
};
...
{
  return &::gps_msgs::msg::rosidl_typesupport_cpp::GPSStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gps_msgs, msg, GPSStatus)() {
  return get_message_type_support_handle<gps_msgs::msg::GPSStatus>();
}
