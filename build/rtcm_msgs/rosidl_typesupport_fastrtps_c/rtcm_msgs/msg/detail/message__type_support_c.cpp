...
#include "rtcm_msgs/msg/detail/message__rosidl_typesupport_fastrtps_c.h"
...
#include "rtcm_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // message
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // message
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_rtcm_msgs
...
using _Message__ros_msg_type = rtcm_msgs__msg__Message;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: message
  {
    ...
    if (ros_message->message.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->message);
    }
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->message, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtcm_msgs
size_t get_serialized_size_rtcm_msgs__msg__Message(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Message__ros_msg_type * ros_message = static_cast<const _Message__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Message__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtcm_msgs__msg__Message(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtcm_msgs
size_t max_serialized_size_rtcm_msgs__msg__Message(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcm_msgs__msg__Message;
    is_plain =
      (
...
static size_t _Message__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtcm_msgs__msg__Message(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtcm_msgs, msg, Message)() {
