...
#include "rtcm_msgs/msg/detail/message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtcm_msgs::msg::Message & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtcm_msgs::msg::Message & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: message
  {
    ...
    size_t item_size = sizeof(ros_message.message[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtcm_msgs::msg::Message;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rtcm_msgs::msg::Message *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtcm_msgs::msg::Message *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_rtcm_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<rtcm_msgs::msg::Message>()
{
  return &rtcm_msgs::msg::typesupport_fastrtps_cpp::_Message__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtcm_msgs, msg, Message)() {
  return &rtcm_msgs::msg::typesupport_fastrtps_cpp::_Message__handle;
}
