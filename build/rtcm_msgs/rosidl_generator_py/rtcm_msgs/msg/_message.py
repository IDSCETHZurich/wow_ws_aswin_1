...
class Metaclass_Message(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('rtcm_msgs')
        except ImportError:
            import logging
            import traceback
...
class Message(metaclass=Metaclass_Message):
    ...
    def __init__(self, **kwargs):
        ...
        self.message = array.array('B', kwargs.get('message', []))
        ...
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'B', \
                    "The 'message' array.array() must have the type code of 'B'"
                self._message = value
                return
            ...
            assert \
                ...
                "The 'message' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._message = array.array('B', value)
