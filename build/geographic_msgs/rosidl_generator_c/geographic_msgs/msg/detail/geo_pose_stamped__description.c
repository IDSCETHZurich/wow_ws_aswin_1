...
geographic_msgs__msg__GeoPoseStamped__get_type_hash(
...
static char geographic_msgs__msg__GeoPoseStamped__FIELD_NAME__header[] = "header";
static char geographic_msgs__msg__GeoPoseStamped__FIELD_NAME__pose[] = "pose";

static rosidl_runtime_c__type_description__Field geographic_msgs__msg__GeoPoseStamped__FIELDS[] = {
  {
    {geographic_msgs__msg__GeoPoseStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geographic_msgs__msg__GeoPoseStamped__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geographic_msgs__msg__GeoPoseStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
geographic_msgs__msg__GeoPoseStamped__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {geographic_msgs__msg__GeoPoseStamped__FIELDS, 2, 2},
    },
    {geographic_msgs__msg__GeoPoseStamped__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
geographic_msgs__msg__GeoPoseStamped__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
geographic_msgs__msg__GeoPoseStamped__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geographic_msgs__msg__GeoPoseStamped__get_individual_type_description_source(NULL),
