  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe8, 0xe8, 0x7d, 0x7b, 0xc0, 0x2d, 0x09, 0x2b,
      0xe5, 0x64, 0xbe, 0x3b, 0x6a, 0x2c, 0xa2, 0x30,
      0x2f, 0xf6, 0x99, 0x7a, 0x82, 0xb9, 0x96, 0xe4,
      0xc6, 0xa9, 0x05, 0x2b, 0x88, 0xe0, 0x9a, 0xac,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t geographic_msgs__msg__GeoPoseWithCovariance__EXPECTED_HASH = {1, {
...
static char geographic_msgs__msg__GeoPoseWithCovarianceStamped__TYPE_NAME[] = "geographic_msgs/msg/GeoPoseWithCovarianceStamped";
...
static char geographic_msgs__msg__GeoPoseWithCovarianceStamped__FIELD_NAME__header[] = "header";
static char geographic_msgs__msg__GeoPoseWithCovarianceStamped__FIELD_NAME__pose[] = "pose";

static rosidl_runtime_c__type_description__Field geographic_msgs__msg__GeoPoseWithCovarianceStamped__FIELDS[] = {
  {
    {geographic_msgs__msg__GeoPoseWithCovarianceStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geographic_msgs__msg__GeoPoseWithCovarianceStamped__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geographic_msgs__msg__GeoPoseWithCovarianceStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {geographic_msgs__msg__GeoPoseWithCovarianceStamped__TYPE_NAME, 48, 48},
      {geographic_msgs__msg__GeoPoseWithCovarianceStamped__FIELDS, 2, 2},
    },
    {geographic_msgs__msg__GeoPoseWithCovarianceStamped__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&geographic_msgs__msg__GeoPoseWithCovariance__EXPECTED_HASH, geographic_msgs__msg__GeoPoseWithCovariance__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[3].fields = geographic_msgs__msg__GeoPoseWithCovariance__get_type_description(NULL)->type_description.fields;
...
geographic_msgs__msg__GeoPoseWithCovarianceStamped__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geographic_msgs__msg__GeoPoseWithCovarianceStamped__get_individual_type_description_source(NULL),
    ...
    sources[4] = *geographic_msgs__msg__GeoPoseWithCovariance__get_individual_type_description_source(NULL);
