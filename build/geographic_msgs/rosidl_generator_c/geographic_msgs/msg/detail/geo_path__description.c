...
static char geographic_msgs__msg__GeoPath__FIELD_NAME__header[] = "header";
static char geographic_msgs__msg__GeoPath__FIELD_NAME__poses[] = "poses";

static rosidl_runtime_c__type_description__Field geographic_msgs__msg__GeoPath__FIELDS[] = {
  {
    {geographic_msgs__msg__GeoPath__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geographic_msgs__msg__GeoPath__FIELD_NAME__poses, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geographic_msgs__msg__GeoPath__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {geographic_msgs__msg__GeoPath__FIELDS, 2, 2},
    },
    {geographic_msgs__msg__GeoPath__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[3].fields = geographic_msgs__msg__GeoPoseStamped__get_type_description(NULL)->type_description.fields;
...
geographic_msgs__msg__GeoPath__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geographic_msgs__msg__GeoPath__get_individual_type_description_source(NULL),
    ...
    sources[4] = *geographic_msgs__msg__GeoPoseStamped__get_individual_type_description_source(NULL);
