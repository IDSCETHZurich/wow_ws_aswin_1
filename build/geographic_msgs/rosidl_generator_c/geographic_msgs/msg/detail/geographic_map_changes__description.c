...
static char geographic_msgs__msg__GeographicMapChanges__FIELD_NAME__header[] = "header";
static char geographic_msgs__msg__GeographicMapChanges__FIELD_NAME__diffs[] = "diffs";
static char geographic_msgs__msg__GeographicMapChanges__FIELD_NAME__deletes[] = "deletes";

static rosidl_runtime_c__type_description__Field geographic_msgs__msg__GeographicMapChanges__FIELDS[] = {
  {
    {geographic_msgs__msg__GeographicMapChanges__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geographic_msgs__msg__GeographicMapChanges__FIELD_NAME__diffs, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {geographic_msgs__msg__GeographicMapChanges__FIELD_NAME__deletes, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geographic_msgs__msg__GeographicMapChanges__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {geographic_msgs__msg__GeographicMapChanges__FIELDS, 3, 3},
    },
    {geographic_msgs__msg__GeographicMapChanges__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "\n"
  "std_msgs/Header header                   # stamp specifies time of change\n"
...
geographic_msgs__msg__GeographicMapChanges__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geographic_msgs__msg__GeographicMapChanges__get_individual_type_description_source(NULL),
