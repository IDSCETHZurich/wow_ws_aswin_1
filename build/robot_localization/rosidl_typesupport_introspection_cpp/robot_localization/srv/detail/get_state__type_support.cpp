...
void fetch_function__GetState_Response__state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__GetState_Response__state(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__GetState_Response__state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__GetState_Response__state(untyped_member, index));
...
void fetch_function__GetState_Response__covariance(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__GetState_Response__covariance(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__GetState_Response__covariance(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__GetState_Response__covariance(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetState_Response_message_member_array[2] = {
  {
    ...
    fetch_function__GetState_Response__state,  // fetch(index, &value) function pointer
    assign_function__GetState_Response__state,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "covariance",  // name
    ...
    fetch_function__GetState_Response__covariance,  // fetch(index, &value) function pointer
    assign_function__GetState_Response__covariance,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
...
void GetState_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) robot_localization::srv::GetState_Event(_init);
}

void GetState_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_localization::srv::GetState_Event *>(message_memory);
  typed_message->~GetState_Event();
}

size_t size_function__GetState_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<robot_localization::srv::GetState_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<robot_localization::srv::GetState_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<robot_localization::srv::GetState_Request> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__GetState_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const robot_localization::srv::GetState_Request *>(
    get_const_function__GetState_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<robot_localization::srv::GetState_Request *>(untyped_value);
  value = item;
}
...
void assign_function__GetState_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<robot_localization::srv::GetState_Request *>(
    get_function__GetState_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const robot_localization::srv::GetState_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<robot_localization::srv::GetState_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<robot_localization::srv::GetState_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<robot_localization::srv::GetState_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__GetState_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const robot_localization::srv::GetState_Response *>(
    get_const_function__GetState_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<robot_localization::srv::GetState_Response *>(untyped_value);
  value = item;
}
...
void assign_function__GetState_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<robot_localization::srv::GetState_Response *>(
    get_function__GetState_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const robot_localization::srv::GetState_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetState_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_localization::srv::GetState_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robot_localization::srv::GetState_Request>(),  // members of sub message
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(robot_localization::srv::GetState_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robot_localization::srv::GetState_Response>(),  // members of sub message
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(robot_localization::srv::GetState_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetState_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(robot_localization::srv::GetState_Event),
...
{
  return &::robot_localization::srv::rosidl_typesupport_introspection_cpp::GetState_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_localization, srv, GetState_Event)() {
  return &::robot_localization::srv::rosidl_typesupport_introspection_cpp::GetState_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetState_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robot_localization::srv::GetState_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robot_localization::srv::GetState_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robot_localization::srv::GetState_Event>(),
