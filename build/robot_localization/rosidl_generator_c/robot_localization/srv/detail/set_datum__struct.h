...
enum
{
  robot_localization__srv__SetDatum_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robot_localization__srv__SetDatum_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetDatum in the package robot_localization.
typedef struct robot_localization__srv__SetDatum_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robot_localization__srv__SetDatum_Request__Sequence request;
  robot_localization__srv__SetDatum_Response__Sequence response;
} robot_localization__srv__SetDatum_Event;

// Struct for a sequence of robot_localization__srv__SetDatum_Event.
typedef struct robot_localization__srv__SetDatum_Event__Sequence
{
