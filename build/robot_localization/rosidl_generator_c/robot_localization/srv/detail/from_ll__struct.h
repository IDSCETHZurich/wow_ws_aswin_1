...
enum
{
  robot_localization__srv__FromLL_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robot_localization__srv__FromLL_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/FromLL in the package robot_localization.
typedef struct robot_localization__srv__FromLL_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robot_localization__srv__FromLL_Request__Sequence request;
  robot_localization__srv__FromLL_Response__Sequence response;
} robot_localization__srv__FromLL_Event;

// Struct for a sequence of robot_localization__srv__FromLL_Event.
typedef struct robot_localization__srv__FromLL_Event__Sequence
{
