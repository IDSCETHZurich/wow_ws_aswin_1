...
[[deprecated("use robot_localization::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robot_localization::srv::GetState_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robot_localization::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robot_localization::srv::to_yaml() instead")]]
inline std::string to_yaml(const robot_localization::srv::GetState_Event & msg)
{
  return robot_localization::srv::to_yaml(msg);
}

template<>
inline const char * data_type<robot_localization::srv::GetState_Event>()
{
  return "robot_localization::srv::GetState_Event";
}

template<>
inline const char * name<robot_localization::srv::GetState_Event>()
{
  return "robot_localization/srv/GetState_Event";
}

template<>
struct has_fixed_size<robot_localization::srv::GetState_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robot_localization::srv::GetState_Event>
  : std::integral_constant<bool, has_bounded_size<robot_localization::srv::GetState_Request>::value && has_bounded_size<robot_localization::srv::GetState_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robot_localization::srv::GetState_Event>
  : std::true_type {};
