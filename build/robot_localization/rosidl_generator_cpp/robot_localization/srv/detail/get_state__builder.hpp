...
{
public:
  explicit Init_GetState_Event_response(::robot_localization::srv::GetState_Event & msg)
  : msg_(msg)
  {}
  ::robot_localization::srv::GetState_Event response(::robot_localization::srv::GetState_Event::_response_type arg)
  {
...
private:
  ::robot_localization::srv::GetState_Event msg_;
};

class Init_GetState_Event_request
{
public:
  explicit Init_GetState_Event_request(::robot_localization::srv::GetState_Event & msg)
  : msg_(msg)
  {}
  Init_GetState_Event_response request(::robot_localization::srv::GetState_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetState_Event_request info(::robot_localization::srv::GetState_Event::_info_type arg)
  {
...
template<>
inline
auto build<::robot_localization::srv::GetState_Event>()
{
  return robot_localization::srv::builder::Init_GetState_Event_info();
}
