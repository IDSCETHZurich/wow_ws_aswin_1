...
// functions for robot_localization::srv::SetDatum_Request already declared above

// functions for robot_localization::srv::SetDatum_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_localization
cdr_serialize(
  const robot_localization::srv::SetDatum_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_localization::srv::SetDatum_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_localization
max_serialized_size_SetDatum_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_localization::srv::typesupport_fastrtps_cpp::max_serialized_size_SetDatum_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_localization::srv::typesupport_fastrtps_cpp::max_serialized_size_SetDatum_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_localization::srv::SetDatum_Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_localization::srv::SetDatum_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_localization::srv::SetDatum_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetDatum_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_localization::srv::SetDatum_Event *>(
...
static size_t _SetDatum_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetDatum_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetDatum_Event__callbacks = {
  "robot_localization::srv",
  "SetDatum_Event",
...
static rosidl_message_type_support_t _SetDatum_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetDatum_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &robot_localization::srv::typesupport_fastrtps_cpp::_SetDatum_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_localization, srv, SetDatum_Event)() {
  return &robot_localization::srv::typesupport_fastrtps_cpp::_SetDatum_Event__handle;
}
...
static const rosidl_service_type_support_t _SetDatum__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetDatum__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<robot_localization::srv::SetDatum_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<robot_localization::srv::SetDatum_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<robot_localization::srv::SetDatum_Event>(),
