...
using _GetState_Event__ros_msg_type = robot_localization__srv__GetState_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robot_localization, srv, GetState_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robot_localization, srv, GetState_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _GetState_Event__ros_msg_type * ros_message = static_cast<_GetState_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      robot_localization__srv__GetState_Request__Sequence__fini(&ros_message->request);
    }
    if (!robot_localization__srv__GetState_Request__Sequence__init(&ros_message->request, size)) {
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      robot_localization__srv__GetState_Response__Sequence__fini(&ros_message->response);
    }
    if (!robot_localization__srv__GetState_Response__Sequence__init(&ros_message->response, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_localization
size_t get_serialized_size_robot_localization__srv__GetState_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetState_Event__ros_msg_type * ros_message = static_cast<const _GetState_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_robot_localization__srv__GetState_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_robot_localization__srv__GetState_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_localization__srv__GetState_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_localization
size_t max_serialized_size_robot_localization__srv__GetState_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robot_localization__srv__GetState_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robot_localization__srv__GetState_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_localization__srv__GetState_Event;
    is_plain =
      (
...
static size_t _GetState_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_localization__srv__GetState_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_localization, srv, GetState_Event)() {
