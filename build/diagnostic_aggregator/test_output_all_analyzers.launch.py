...
def generate_test_description():
    ...
    aggregator_node = ExecuteProcess(
        cmd=[
            ...
            "--ros-args",
            "--params-file",
            "/home/pi/wow_ws/src/diagnostics/diagnostic_aggregator/test/all_analyzers.yaml"
            ],
...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, launch_service, proc_info, proc_output):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/pi/wow_ws/src/diagnostics/diagnostic_aggregator/test/expected_output/output_all_analyzers"),
